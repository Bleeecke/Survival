...
const campfire = B({
  ...
  requiredTools: [],
  requiredSkills: [{ skill: 'survival', level: 1 }],
...
const palmShelter = B({
  ...
  requiredTools: [],
  requiredSkills: [{ skill: 'building', level: 1 }],
...
const woodenShelter = B({
  ...
  requiredSkills: [{ skill: 'building', level: 2 }, { skill: 'crafting', level: 1 }],
...
const logCabin = B({
  ...
  requiredTools: ['stone_axe'],
  requiredSkills: [{ skill: 'building', level: 3 }, { skill: 'crafting', level: 3 }],
  requiredKnowledge: ['knows_construction'],
...
const storageBox = B({
  ...
  requiredTools: ['stone_axe'],
  requiredSkills: [{ skill: 'crafting', level: 2 }],
  requiredKnowledge: ['knows_construction'],
...
const graniteCampfire = B({
  ...
  requiredSkills: [{ skill: 'survival', level: 2 }],
...
const smokingRack = B({
  ...
  requiredTools: [],
  requiredSkills: [{ skill: 'survival', level: 3 }, { skill: 'cooking', level: 2 }],
...
const furnace = B({
  ...
  requiredTools: ['stone_axe'],
  requiredSkills: [{ skill: 'survival', level: 4 }, { skill: 'crafting', level: 4 }],
...
const farmPlot = B({
  ...
  requiredTools: [],
  requiredSkills: [{ skill: 'naturelore', level: 3 }],
  requiredKnowledge: ['knows_construction'],
  visibleWhenSeen: ['plank'],
  buildTime: 120,
});
...
const herbDryingRack = B({
  ...
  requiredTools: [],
  requiredSkills: [{ skill: 'naturelore', level: 2 }],
