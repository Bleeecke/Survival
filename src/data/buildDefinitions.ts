...
const storageSpot = B({
  ...
  icon: '🟫',
  category: 'survival',
  description: 'Markierter Bodenplatz – lege Gegenstände hier ab. Kein Schutz gegen Regen oder Tiere.',
  effects: ['Markierter Lagerbereich', 'Gegenstände ungeschützt'],
  requiredMaterials: [],
  requiredTools: [],
  requiredSkills: [],
  requiredKnowledge: [],
...
const campfire = B({
  ...
  requiredMaterials: [{ item: 'sticks', amount: 5 }, { item: 'pebbles', amount: 3 }],
  requiredTools: [],
  requiredSkills: [{ skill: 'firemaking', level: 1 }],
  requiredKnowledge: ['knows_basic_fire'],
  visibleWhenSeen: ['sticks', 'pebbles'],
  buildTime: 8,
...
const sleepingSpot = B({
  ...
  icon: '🌿',
  category: 'survival',
  description: 'Palmblätter als Unterlage – besser als bloßer Boden, kaum Schutz.',
  effects: ['Schlafen möglich', 'Leicht bessere Erholung als Boden', 'Kein Schutz gegen Regen oder Kälte'],
