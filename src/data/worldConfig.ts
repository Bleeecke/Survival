...
export const WORLD_CONFIG = {
  ...
  resources: {
    ...
    driftwood:    { frequency: 0.010, minQuantity: 1, maxQuantity: 2, spawnOn: ['beach'] },
    sticks:       { frequency: 0.04,  minQuantity: 1, maxQuantity: 4, spawnOn: ['sparse_forest', 'forest', 'dense_jungle', 'grass', 'tall_grass'] },
