...
export default function IntroModal() {
  ...
  return (
    <div className="fixed inset-0 z-[900] flex items-center justify-center"
      ...
      <div className="relative bg-slate-900 border border-slate-600 rounded-2xl shadow-2xl overflow-hidden flex"
        ...
        <div className="flex flex-col flex-1 min-w-0">
          {/* Top accent bar */}
          <div className="h-1 bg-gradient-to-r from-blue-600 via-teal-500 to-green-500 flex-shrink-0" />
